...
| `github_request_reviewers` | Request reviewers for a pull request |
...
| `github_add_labels` | Compatibility alias: add labels to issue/PR |
| `github_remove_label` | Compatibility alias: remove a single label |
